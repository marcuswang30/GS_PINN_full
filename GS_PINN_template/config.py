...
kappa_vals = 1.7
R0 = 5 #giving it an arbitrary value for now 
a = 1 #see above with R0

# Training hyperparameters
n_train_tasks = None    # Will be computed based on the grid of task parameters
n_meta_train = 8        # Number of tasks for meta-training
max_iters = 100         # Maximum iterations for meta-learning training loop
max_lr = 1e-1           # Maximum learning rate for the scheduler

# Trial number
trial = 'iPINN_34_x64' ### CHANGE
...
inverse_max_iters = 200        # Maximum iterations for inverse training loop
